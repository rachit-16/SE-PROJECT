...
int main()
{
    ...
    return (
      <div className="nqueencomp">
        ...
        <div className="NQwidth">
          <div className="nqueen">
            <div className="nq-main-content">
              <div className="nq-controls">
                ...
                <div className="Qbox Qboard" id="nQueensBoard"></div>
                <div className="row">
                  <div className="input-group container col-sm-6">
              ...
              <div id="NQueenResults" className="NQueenResults col-sm-4"></div>
            </div>
            <div className="nq-footer-text">
              {!disabled ? (
                <center>
        ...
        <div>
          <Practice show={this.props.show} code={NQCode} />
        </div>
      </div>
    )
  }
